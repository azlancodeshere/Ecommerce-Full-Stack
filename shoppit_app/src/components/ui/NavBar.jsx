    ...
    <nav className={`navbar navbar-expand-lg navbar-light bg-white shadow-sm py-3 ${styles.stickyNavbar}`}>
      <div className="container">
        ...
        <div className="d-flex align-items-center d-lg-none ms-auto gap-2">
          ...
          <Link to="/cart" className={`btn btn-dark rounded-pill position-relative ${styles.responsiveCart}`}>
            <FaShoppingCart />
            {numCartItems > 0 && (
              <span
        ...
        <div className="collapse navbar-collapse" id="navbarContent">
          ...
          <Link to="/cart" className={`btn btn-dark ms-3 rounded-pill position-relative d-none d-lg-inline-flex ${styles.responsiveCart}`}>
            <FaShoppingCart />
            {numCartItems > 0 && (
              <span
                className="position-absolute top-0 start-100 translate-middle badge rounded-pill"
